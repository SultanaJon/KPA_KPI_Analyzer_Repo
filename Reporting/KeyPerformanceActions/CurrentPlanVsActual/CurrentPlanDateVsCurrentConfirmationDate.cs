    ...
    public sealed class CurrentPlanDateVsCurrentConfirmationDate : KeyPerformanceAction
    {
        ...
        public override void RunSelectiveReport(string uniqueFilters)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                // If the requisition date is 00/00/0000 than get the delivery date instead
                ...
                // Find the difference between the current confirmation date and the current plan date (rescheduling date)
