...
{
    public sealed class POPrevRelease : KeyPerformanceAction, ISelective,  ITemplateOne
    {
        ...
        internal override void CalculateAverage(double _totalDays)
        {
            ...
            {
                MessageBox.Show("An argument out of range exception was thrown", "Purch -> PO Previous Release - Average Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                Application.Exit();
            }
