...
namespace Reporting.KeyPerformanceActions.ExcessStockStock
{
    public sealed class POCreationThruDelivery : KeyPerformanceAction, ISelective,  ITemplateOne
    {
        ...
        internal override void CalculateAverage(double _totalDays)
        {
            ...
            {
                MessageBox.Show("An argument out of range exception was thrown", "Excess Stock - Stock -> PO Creation Thru Delivery - Average Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                Application.Exit();
            }
