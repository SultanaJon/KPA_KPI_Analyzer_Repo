...
{
    public sealed class PRReleaseToPORelease : KeyPerformanceAction, ISelective,  ITemplateOne
    {
        ...
        internal override void CalculateAverage(double _totalDays, int _totalRecords)
        {
            ...
            {
                MessageBox.Show("An argument out of range exception was thrown", "Purch Sub -> PR Release to PO Release - Average Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                Application.Exit();
            }
