...
{
    public sealed class DueTodayOrLateToConfirmed : KeyPerformanceAction, ISelective,  ITemplateOne
    {
        ...
        internal override void CalculateAverage(double _totalDays, int _totalRecords)
        {
            ...
            {
                MessageBox.Show("An argument out of range exception was thrown", "Folow Up -> Due Today or Late to Confirmed - Average Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                Application.Exit();
            }
