...
namespace KPA_KPI_Analyzer.DatabaseUtils
{
    public class PRPOCommands
    {
        ...
        public static string[] usQueries =
        {
            ...
            "SELECT * FROM " + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + " WHERE " + "(" + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + ".[Open PR Qty] > 0 AND " + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + ".[Release Ind#] <> 2 AND (" + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + ".[Gen# Stock On Hand] > 0 OR " + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + ".[Project Stk On Hand] > 0))" ,
            "SELECT * FROM " + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + " WHERE " + "(" + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + ".[Open PR Qty] > 0 AND " + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + ".[Release Ind#] = 2 AND (" + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + ".[Gen# Stock On Hand] > 0 OR " + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + ".[Project Stk On Hand] > 0))" ,
            "SELECT * FROM " + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + " WHERE " + "(" + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + ".[Qty Ordered] > 0 AND " + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + ".[Escaped] IS NULL AND (" + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + ".[Gen# Stock On Hand] > 0 OR " + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + ".[Project Stk On Hand] > 0))" ,

            // KPA -> Excess Stock - Open Order
            "SELECT * FROM " + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + " WHERE " + "(" + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + ".[Open PR Qty] > 0 AND " + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + ".[Release Ind#] <> 2 AND (" + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + ".[General Stock On Ord] > 0 OR " + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + ".[Project Stock On Ord] > 0))" ,
            "SELECT * FROM " + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + " WHERE " + "(" + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + ".[Open PR Qty] > 0 AND " + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + ".[Release Ind#] = 2 AND (" + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + ".[General Stock On Ord] > 0 OR " + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + ".[Project Stock On Ord] > 0))" ,
            "SELECT * FROM " + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + " WHERE " + "(" + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + ".[Qty Ordered] > 0 AND " + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + ".[Escaped] IS NULL AND (" + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + ".[General Stock On Ord] > 0 OR " + mainTableNames[(int)DatabaseTables.MainTables.US_PRPO] + ".[Project Stock On Ord] > 0))" ,
        ...
        public static string[] mxQueries =
        {
            ...
            // KPA -> Excess Stock - Stock
            "SELECT * FROM " + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + " WHERE " + "(" + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + ".[Open PR Qty] > 0 AND " + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + ".[Release Ind#] <> 2 AND (" + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + ".[Gen# Stock On Hand] > 0 OR " + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + ".[Project Stk On Hand] > 0))" ,
            "SELECT * FROM " + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + " WHERE " + "(" + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + ".[Open PR Qty] > 0 AND " + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + ".[Release Ind#] = 2 AND (" + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + ".[Gen# Stock On Hand] > 0 OR " + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + ".[Project Stk On Hand] > 0))" ,
            "SELECT * FROM " + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + " WHERE " + "(" + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + ".[Qty Ordered] > 0 AND " + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + ".[Escaped] IS NULL AND (" + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + ".[Gen# Stock On Hand] > 0 OR " + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + ".[Project Stk On Hand] > 0))" ,

            // KPA -> Excess Stock - Open Order
            "SELECT * FROM " + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + " WHERE " + "(" + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + ".[Open PR Qty] > 0 AND " + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + ".[Release Ind#] <> 2 AND (" + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + ".[General Stock On Ord] > 0 OR " + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + ".[Project Stock On Ord] > 0))" ,
            "SELECT * FROM " + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + " WHERE " + "(" + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + ".[Open PR Qty] > 0 AND " + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + ".[Release Ind#] = 2 AND (" + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + ".[General Stock On Ord] > 0 OR " + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + ".[Project Stock On Ord] > 0))" ,
            "SELECT * FROM " + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + " WHERE " + "(" + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + ".[Qty Ordered] > 0 AND " + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + ".[Escaped] IS NULL AND (" + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + ".[General Stock On Ord] > 0 OR " + mainTableNames[(int)DatabaseTables.MainTables.MX_PRPO] + ".[Project Stock On Ord] > 0))" ,
