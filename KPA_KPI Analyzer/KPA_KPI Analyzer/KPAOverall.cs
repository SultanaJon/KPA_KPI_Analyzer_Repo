...
namespace KPA_KPI_Analyzer
{
    public partial class KPAOverall : UserControl
    {
        ...
        public void LoadTemplate(Overall overallData)
        {
            ...
            lbl_kpaCurrPlanVsActualCurrPlanDateVsCurrConf_One.Text = string.Format( "{0:n}",  overallData.kpa.currPlanVsActual.currPlanDateCurrConfDate.data.Average + " Week(s)");
            lbl_kpaCurrPlanVsActualCurrPlanDateVsCurrConf_Two.Text = string.Format( "{0:n0}",  overallData.kpa.currPlanVsActual.currPlanDateCurrConfDate.data.LessThanMinusFourWeeks);
            lbl_kpaCurrPlanVsActualCurrPlanDateVsCurrConf_Three.Text = string.Format( "{0:n0}",  overallData.kpa.currPlanVsActual.currPlanDateCurrConfDate.data.LessThanMinusThreeWeeks);
            lbl_kpaCurrPlanVsActualCurrPlanDateVsCurrConf_Four.Text = string.Format( "{0:n0}",  overallData.kpa.currPlanVsActual.currPlanDateCurrConfDate.data.LessThanMinusTwoWeeks);
            lbl_kpaCurrPlanVsActualCurrPlanDateVsCurrConf_Five.Text = string.Format( "{0:n0}",  overallData.kpa.currPlanVsActual.currPlanDateCurrConfDate.data.LessThanMinusOneWeeks);
            ...
            lbl_kpaCurrPlanVsActualCurrPlanDateVsCurrConf_Seven.Text = string.Format( "{0:n0}",  overallData.kpa.currPlanVsActual.currPlanDateCurrConfDate.data.OneWeek);
            lbl_kpaCurrPlanVsActualCurrPlanDateVsCurrConf_Eight.Text = string.Format( "{0:n0}",  overallData.kpa.currPlanVsActual.currPlanDateCurrConfDate.data.TwoWeeks);
            lbl_kpaCurrPlanVsActualCurrPlanDateVsCurrConf_Nine.Text = string.Format( "{0:n0}",  overallData.kpa.currPlanVsActual.currPlanDateCurrConfDate.data.ThreeWeeks);
            lbl_kpaCurrPlanVsActualCurrPlanDateVsCurrConf_Ten.Text = string.Format( "{0:n0}",  overallData.kpa.currPlanVsActual.currPlanDateCurrConfDate.data.FourWeeksPlus);



            // KPA -> Current Planned Date vs Current Conf Date (Hot Jobs Only)
            lbl_kpaCurrPlanVsActualCurrPlanDateVsCurrConfHotJobs_One.Text = string.Format("{0:n}", overallData.kpa.currPlanVsActual.currPlanDateCurrConfDateHotJobs.data.Average + " Week(s)");
            lbl_kpaCurrPlanVsActualCurrPlanDateVsCurrConfHotJobs_Two.Text = string.Format("{0:n0}", overallData.kpa.currPlanVsActual.currPlanDateCurrConfDateHotJobs.data.LessThanMinusFourWeeks);
            lbl_kpaCurrPlanVsActualCurrPlanDateVsCurrConfHotJobs_Three.Text = string.Format("{0:n0}", overallData.kpa.currPlanVsActual.currPlanDateCurrConfDateHotJobs.data.LessThanMinusThreeWeeks);
            lbl_kpaCurrPlanVsActualCurrPlanDateVsCurrConfHotJobs_Four.Text = string.Format("{0:n0}", overallData.kpa.currPlanVsActual.currPlanDateCurrConfDateHotJobs.data.LessThanMinusTwoWeeks);
            lbl_kpaCurrPlanVsActualCurrPlanDateVsCurrConfHotJobs_Five.Text = string.Format("{0:n0}", overallData.kpa.currPlanVsActual.currPlanDateCurrConfDateHotJobs.data.LessThanMinusOneWeeks);
            ...
            lbl_kpaCurrPlanVsActualCurrPlanDateVsCurrConfHotJobs_Seven.Text = string.Format("{0:n0}", overallData.kpa.currPlanVsActual.currPlanDateCurrConfDateHotJobs.data.OneWeek);
            lbl_kpaCurrPlanVsActualCurrPlanDateVsCurrConfHotJobs_Eight.Text = string.Format("{0:n0}", overallData.kpa.currPlanVsActual.currPlanDateCurrConfDateHotJobs.data.TwoWeeks);
            lbl_kpaCurrPlanVsActualCurrPlanDateVsCurrConfHotJobs_Nine.Text = string.Format("{0:n0}", overallData.kpa.currPlanVsActual.currPlanDateCurrConfDateHotJobs.data.ThreeWeeks);
            lbl_kpaCurrPlanVsActualCurrPlanDateVsCurrConfHotJobs_Ten.Text = string.Format("{0:n0}", overallData.kpa.currPlanVsActual.currPlanDateCurrConfDateHotJobs.data.FourWeeksPlus);
