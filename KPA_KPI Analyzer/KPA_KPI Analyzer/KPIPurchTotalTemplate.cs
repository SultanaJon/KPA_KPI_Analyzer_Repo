...
namespace KPA_KPI_Analyzer
{
    public partial class KPIPurchTotalTemplate : UserControl
    {
        ...
        private void RenderOne()
        {
            ...
            TimeBucketTen = overallData.kpi.purchTotal.prRelConfEntry.data.greaterThanEqualFifty.ToString();
            ...
            PercNoConf = String.Format("{0:n0}", overallData.kpi.purchTotal.prRelConfEntry.data.PercentUnconf);
            ...
            TimeBucketTen = String.Format("{0:n0}", overallData.kpi.purchTotal.prRelConfEntry.data.greaterThanEqualFifty);
