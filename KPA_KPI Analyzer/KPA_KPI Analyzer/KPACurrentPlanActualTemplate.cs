...
namespace KPA_KPI_Analyzer
{
    public partial class KPACurrentPlanActualTemplate : UserControl
    {
        ...
        private void RenderCurrPlanCurrConfDateOpenPO()
        {
            ...
            TimeBucketOne = overallData.kpa.currPlanVsActual.currPlanDateCurrConfDate.data.LessThanMinusFourWeeks.ToString();
            TimeBucketTwo = overallData.kpa.currPlanVsActual.currPlanDateCurrConfDate.data.LessThanMinusThreeWeeks.ToString();
            TimeBucketThree = overallData.kpa.currPlanVsActual.currPlanDateCurrConfDate.data.LessThanMinusTwoWeeks.ToString();
            TimeBucketFour = overallData.kpa.currPlanVsActual.currPlanDateCurrConfDate.data.LessThanMinusOneWeeks.ToString();
            TimeBucketFive = overallData.kpa.currPlanVsActual.currPlanDateCurrConfDate.data.ZeroWeeks.ToString();
            TimeBucketSix = overallData.kpa.currPlanVsActual.currPlanDateCurrConfDate.data.OneWeek.ToString();
            TimeBucketSeven = overallData.kpa.currPlanVsActual.currPlanDateCurrConfDate.data.TwoWeeks.ToString();
            TimeBucketEight = overallData.kpa.currPlanVsActual.currPlanDateCurrConfDate.data.ThreeWeeks.ToString();
            TimeBucketNine = overallData.kpa.currPlanVsActual.currPlanDateCurrConfDate.data.FourWeeksPlus.ToString();
            ...
            TimeBucketOne = String.Format("{0:n0}", overallData.kpa.currPlanVsActual.currPlanDateCurrConfDate.data.LessThanMinusFourWeeks);
            TimeBucketTwo = String.Format("{0:n0}", overallData.kpa.currPlanVsActual.currPlanDateCurrConfDate.data.LessThanMinusThreeWeeks);
            TimeBucketThree = String.Format("{0:n0}", overallData.kpa.currPlanVsActual.currPlanDateCurrConfDate.data.LessThanMinusTwoWeeks);
            TimeBucketFour = String.Format("{0:n0}", overallData.kpa.currPlanVsActual.currPlanDateCurrConfDate.data.LessThanMinusOneWeeks);
            TimeBucketFive = String.Format("{0:n0}", overallData.kpa.currPlanVsActual.currPlanDateCurrConfDate.data.ZeroWeeks);
            TimeBucketSix = String.Format("{0:n0}", overallData.kpa.currPlanVsActual.currPlanDateCurrConfDate.data.OneWeek);
            TimeBucketSeven = String.Format("{0:n0}", overallData.kpa.currPlanVsActual.currPlanDateCurrConfDate.data.TwoWeeks);
            TimeBucketEight = String.Format("{0:n0}", overallData.kpa.currPlanVsActual.currPlanDateCurrConfDate.data.ThreeWeeks);
            TimeBucketNine = String.Format("{0:n0}", overallData.kpa.currPlanVsActual.currPlanDateCurrConfDate.data.FourWeeksPlus);
        ...
        private void RenderCurrPlanCurrConfDateHotJobs()
        {
            ...
            TimeBucketOne = overallData.kpa.currPlanVsActual.currPlanDateCurrConfDateHotJobs.data.LessThanMinusFourWeeks.ToString();
            TimeBucketTwo = overallData.kpa.currPlanVsActual.currPlanDateCurrConfDateHotJobs.data.LessThanMinusThreeWeeks.ToString();
            TimeBucketThree = overallData.kpa.currPlanVsActual.currPlanDateCurrConfDateHotJobs.data.LessThanMinusTwoWeeks.ToString();
            TimeBucketFour = overallData.kpa.currPlanVsActual.currPlanDateCurrConfDateHotJobs.data.LessThanMinusOneWeeks.ToString();
            TimeBucketFive = overallData.kpa.currPlanVsActual.currPlanDateCurrConfDateHotJobs.data.ZeroWeeks.ToString();
            TimeBucketSix = overallData.kpa.currPlanVsActual.currPlanDateCurrConfDateHotJobs.data.OneWeek.ToString();
            TimeBucketSeven = overallData.kpa.currPlanVsActual.currPlanDateCurrConfDateHotJobs.data.TwoWeeks.ToString();
            TimeBucketEight = overallData.kpa.currPlanVsActual.currPlanDateCurrConfDateHotJobs.data.ThreeWeeks.ToString();
            TimeBucketNine = overallData.kpa.currPlanVsActual.currPlanDateCurrConfDateHotJobs.data.FourWeeksPlus.ToString();
            ...
            AnalysisOne = "- Will only show if the PO line has a confirmed date and the PO is not received complete.";
            ...
            TimeBucketOne = String.Format("{0:n0}", overallData.kpa.currPlanVsActual.currPlanDateCurrConfDateHotJobs.data.LessThanMinusFourWeeks);
            TimeBucketTwo = String.Format("{0:n0}", overallData.kpa.currPlanVsActual.currPlanDateCurrConfDateHotJobs.data.LessThanMinusThreeWeeks);
            TimeBucketThree = String.Format("{0:n0}", overallData.kpa.currPlanVsActual.currPlanDateCurrConfDateHotJobs.data.LessThanMinusTwoWeeks);
            TimeBucketFour = String.Format("{0:n0}", overallData.kpa.currPlanVsActual.currPlanDateCurrConfDateHotJobs.data.LessThanMinusOneWeeks);
            TimeBucketFive = String.Format("{0:n0}", overallData.kpa.currPlanVsActual.currPlanDateCurrConfDateHotJobs.data.ZeroWeeks);
            TimeBucketSix = String.Format("{0:n0}", overallData.kpa.currPlanVsActual.currPlanDateCurrConfDateHotJobs.data.OneWeek);
            TimeBucketSeven = String.Format("{0:n0}", overallData.kpa.currPlanVsActual.currPlanDateCurrConfDateHotJobs.data.TwoWeeks);
            TimeBucketEight = String.Format("{0:n0}", overallData.kpa.currPlanVsActual.currPlanDateCurrConfDateHotJobs.data.ThreeWeeks);
            TimeBucketNine = String.Format("{0:n0}", overallData.kpa.currPlanVsActual.currPlanDateCurrConfDateHotJobs.data.FourWeeksPlus);
