...
namespace KPA_KPI_Analyzer
{
    public partial class KPIPurchTwoTemplate : UserControl
    {
        ...
        private void RenderOne()
        {
            ...
            TimeBucketTen = overallData.kpi.purchTwo.pr2ndLvlRelVsPOCreation.data.greaterThanEqualFifty.ToString();
            ...
            TimeBucketTen = String.Format("{0:n0}", overallData.kpi.purchTwo.pr2ndLvlRelVsPOCreation.data.greaterThanEqualFifty);
        ...
        private void RenderTwo()
        {
            ...
            TimeBucketTen = overallData.kpi.purchTwo.poCreationVsPORel.data.greaterThanEqualFifty.ToString();

            AnalysisOne = "- Will show if PO line item has an initial release date.";
            AnalysisTwo = "- Difference between PO line initial release date and PO creation date.";
            ...
            TimeBucketTen = String.Format("{0:n0}", overallData.kpi.purchTwo.poCreationVsPORel.data.greaterThanEqualFifty);
        ...
        private void RenderThree()
        {
            ...
            TimeBucketTen = overallData.kpi.purchTwo.poRelVsPOConf.data.greaterThanEqualFifty.ToString();
            ...
            TimeBucketTen = String.Format("{0:n0}", overallData.kpi.purchTwo.poRelVsPOConf.data.greaterThanEqualFifty);
