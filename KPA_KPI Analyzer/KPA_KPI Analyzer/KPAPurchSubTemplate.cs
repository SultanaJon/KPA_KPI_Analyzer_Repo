...
namespace KPA_KPI_Analyzer
{
    public partial class KPAPurchSubTemplate : UserControl
    {
        ...
        private void RenderPRRelToPORel()
        {
            ...
            AnalysisOne = "- Will only show in this field if PR is fully released";
            ...
            try
            {
                ...
                switch (ActiveCategory)
                {
                    case 0:
                        ...
                        using (DataViewer dv = new DataViewer() { Data = prRelPoRelDt })
                        {
                            dv.LoadData();
                            dv.ShowDialog();
                        }
                    ...
                    case 1:
                        ...
                        using (DataViewer dv = new DataViewer() { Data = poCreatConfEntryDt })
                        {
                            dv.LoadData();
                            dv.ShowDialog();
                        }
