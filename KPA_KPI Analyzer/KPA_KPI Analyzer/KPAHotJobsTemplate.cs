...
namespace KPA_KPI_Analyzer
{
    public partial class KPAHotJobsTemplate : UserControl
    {
        ...
        private void RenderPRsNotOnPO()
        {
            ...
            AnalysisOne = "- Will only show in this field if the PR is released at the 2nd level and the PR has not been placed on a PO.";
        ...
        private void RenderNoConfirmations()
        {
            ...
            AnalysisOne = "- Will only show in this field if the PR is on the PO, the PO has been released at least one time, the line does not have confirmation date and the line is not received complete.";
