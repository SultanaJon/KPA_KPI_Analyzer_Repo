    ...
    public class FollowUp
    {
        ...
        public void LoadData()
        {
            try
            {
                ...
                try
                {
                    initConfVsCurrConf.data.PercentUnconf = (int)((totalUnconfPOs / Overall.posRecCompDt.Rows.Count) * 100);
                }
                ...
                try
                {
                    finalConfDateVsFinalPlan.data.PercentUnconf = (int)((totalUnconfPOs / finalConfDateVsFinalPlan.data.Total) * 100);
                }
                catch (DivideByZeroException)
                {
                ...
                //
                /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                receiptDateVsCurrPlanDate.data.Total = Overall.posRecCompDt.Rows.Count;
                ...
                try
                {
                    receiptDateVsOrigConfDate.data.PercentUnconf = (int)((totalUnconfPOs / receiptDateVsOrigConfDate.data.Total) * 100);
                }
                catch (DivideByZeroException)
                {
                ...
                try
                {
                    receiptDateVsCurrConfDate.data.PercentUnconf = (int)((totalUnconfPOs / receiptDateVsCurrConfDate.data.Total) * 100);
                }
                catch (DivideByZeroException)
                {
