    ...
    public static class QueryManager
    {
        ...
        public static class KpaQueries
        {
            ...
            public static class PurchQueries
            {
                ...
                {
                    return "SELECT * FROM " + table + " WHERE " + "(" + table + ".[Qty Ordered] > 0 AND " + table + ".[PO Line 1st Rel Dt] <> '00/00/0000' AND " + table + ".[Latest Conf#Dt] = '00/00/0000' AND " + table + ".[Escaped] IS NULL)";
                }
            }
            ...
            public static class PurchSubQueries
            {
                ...
                {
                    return "SELECT * FROM " + table + " WHERE " + "(" + table + ".[Qty Ordered] > 0 AND " + table + ".[Latest Conf#Dt] = '00/00/0000' AND " + table + ".[Escaped] IS NULL)";
                }
            }
            ...
            public static class PurchTotalQueries
            {
                ...
                {
                    return "SELECT * FROM " + table + " WHERE " + "(" + table + ".[Release Ind#] = 2 AND " + table + ".[Latest Conf#Dt] = '00/00/0000' AND " + table + ".[Escaped] IS NULL)";
                }
            }
            ...
            public static class HotJobsQueries
            {
                ...
                public static string GetNoConfirmations()
                {
                    return "SELECT * FROM " + table + " WHERE " + "(" + table + ".[Qty Ordered] > 0 AND " + table + ".[Latest Conf#Dt] = '00/00/0000' AND " + table + ".[PO Line Creat#DT] <> '00/00/0000' AND " + table + ".[Purch# Group] = 'UHJ' AND " + table + ".[Escaped] IS NULL)";
                ...
                {
                    return "SELECT * FROM " + table + " WHERE " + "(" + table + ".[Qty Ordered] > 0 AND " + table + ".[Latest Conf#Dt] <> '00/00/0000' AND " + table + ".[Purch# Group] = 'UHJ' AND " + table + ".[Escaped] IS NULL)";
        ...
        public static class KpiQueries
        {
            ...
            {
                return "SELECT * FROM " + table + " WHERE " + "(" + table + ".[Qty Ordered] > 0 AND " + table + ".[Latest Conf#Dt] = '00/00/0000')";
            }
            ...
            {
                return "SELECT * FROM " + table + " WHERE " + "(" + table + ".[Escaped] IS NOT NULL AND " + table + ".[Latest Conf#Dt] = '00/00/0000')";
