...
{
    public class CurrentPlanDateVsCurrentConfirmationDateForHotJobs : TemplateTwoPackage, ICalculateFavorable
    {
        ...
        public void CalculatePercentFavorable()
        {
            if (Total != 0)
            {
                double favorableTimeSpanCounts = this.LessThanNegThreeWeeks + this.GreaterThanEqualNegThreeWeeks + this.GreaterThanEqualNegTwoWeeks + this.GreaterThanEqualNegOneWeek + this.ZeroWeeks;
        ...
        public void Load()
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                // Apply the weeks agains the timespan conditions
