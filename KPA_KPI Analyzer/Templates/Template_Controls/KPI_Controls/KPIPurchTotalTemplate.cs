...
namespace KPA_KPI_Analyzer.Templates.Template_Controls.KPI_Controls
{
    public partial class KPIPurchTotalTemplate : UserControl
    {
        ...
        private void RenderOne()
        {
            ...
            Title = StringUtils.KpiStringUtils.categories[(int)StringUtils.KpiStringUtils.Section.PurchTotal][(int)StringUtils.KpiStringUtils.Category.PurchTotal.PRReleaseDatetoConfirmationEntryDate];
